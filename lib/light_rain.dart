...
class LightRain extends StatefulWidget {
  const LightRain({super.key});

  @override
  State<StatefulWidget> createState() => _LightRain();
}

class _LightRain extends State<LightRain> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            weather('16', 'lightrain', 'Light Rain'),
            const SizedBox(
              height: 50,
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  custom("Humidity", "humidity", "58"),
                  custom("Max Temp", "max-temp", "16C")
                ],
              ),
            ),
            const SizedBox(
